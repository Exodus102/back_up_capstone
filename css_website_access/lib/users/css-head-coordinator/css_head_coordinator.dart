...
class CssHeadCoordinator extends StatefulWidget {
  final String? fname;
  final String? lname;
  ...
  @override
  State<CssHeadCoordinator> createState() => _CssHeadCoordinator();
}

class _CssHeadCoordinator extends State<CssHeadCoordinator> {
