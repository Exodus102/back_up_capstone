...
import 'package:css_website_access/pages/reports/ncar_director_page.dart';
import 'package:css_website_access/pages/reports/ncar_page.dart';
import 'package:css_website_access/pages/reports/reports_page_directors.dart';
...
class Director extends StatefulWidget {
  ...
  @override
  State<Director> createState() => _Director();
}

class _Director extends State<Director> {
                                ...
                                SizedBox(
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () {
                                      setState(() {
                                        _active = "Reports - Reports";
                                        _currentPage = ReportsPageDirectors(
                                          campus: widget.campus,
                                          fname: widget.fname,
                                          lname: widget.lname,
                                          profileImage: widget.profileImage,
