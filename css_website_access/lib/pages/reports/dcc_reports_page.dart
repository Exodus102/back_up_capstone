...
import 'package:css_website_access/pages/reports/dcc_data_table_reports.dart';
import 'package:css_website_access/pages/reports/dcc_view_reports.dart';
...
class DccReportsPage extends StatefulWidget {
  final String? fname;
  final String? lname;
  final Uint8List? profileImage;
  final String? redirectPage;
  final String? campus;
  const DccReportsPage({
    super.key,
    this.fname,
    this.lname,
    this.profileImage,
  ...
  @override
  State<DccReportsPage> createState() => _ReportsPageState();
}

class _ReportsPageState extends State<DccReportsPage> {
  String? selectedDate;
  List<String> date = [];
  bool isLoading = true;
