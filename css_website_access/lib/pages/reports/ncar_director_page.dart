...
class NcarDirectorPage extends StatefulWidget {
  final String? fname;
  final String? lname;
  final Uint8List? profileImage;
  final String? redirectPage;
  final String? campus;
  const NcarDirectorPage({
    super.key,
    this.fname,
    this.lname,
    this.profileImage,
  ...
  @override
  State<NcarDirectorPage> createState() => _NcarPageState();
}

class _NcarPageState extends State<NcarDirectorPage> {
  String? selectedDate;
                  ...
                  SizedBox(
                    ...
                    child: SizedBox(
                      ...
                      child: showReportPage
                          ...
                          : NcarPageDataTableDirector(
                              selectedQuarter: selectedQuarter,
                              campus: widget.campus,
                              width: remainingWidth,
                              selectedYear: selectedDate,
                              onViewReportPressed: (office, filePath) {
                                print("File Path Selected: $filePath");
                                print("Office selected: $office");
                                setState(() {
