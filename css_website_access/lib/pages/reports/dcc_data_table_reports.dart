...
class DccDataTableReports extends StatefulWidget {
  final String? campus;
  final double width;
  final String? selectedYear;
  final Function(String? quarter) onViewReportPressed;

  const DccDataTableReports({
    super.key,
    required this.width,
    this.selectedYear,
...
class _ReportPageDirectorsDataTable extends State<DccDataTableReports> {
  ...
  @override
  void didUpdateWidget(covariant DccDataTableReports oldWidget) {
