...
import 'package:css_website_access/pages/reports/ncar_page_data_table_director.dart';
import 'package:css_website_access/pages/reports/ncar_unit_head_data_table.dart';
import 'package:css_website_access/pages/reports/view_ncar_directors.dart';
import 'package:css_website_access/pages/reports/view_ncar_page.dart';
import 'package:css_website_access/pages/reports/view_table_ncar.dart';
import 'package:css_website_access/pages/reports/view_unit_head.dart';
...
class NcarUnitHead extends StatefulWidget {
  final String? fname;
  final String? lname;
  ...
  @override
  State<NcarUnitHead> createState() => _NcarPageState();
}

class _NcarPageState extends State<NcarUnitHead> {
  String? selectedDate;
        ...
        return Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  if (!showReportPage) // Only show these elements if showNcarTable is false
                    Row(
                      children: [
                        SizedBox(
