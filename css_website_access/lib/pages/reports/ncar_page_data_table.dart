...
class NcarPageDataTable extends StatefulWidget {
  final double width;
...
class NcarPageDataTableState extends State<NcarPageDataTable> {
  ...
  @override
  void didUpdateWidget(NcarPageDataTable oldWidget) {
  ...
  Future<void> fetchOffices() async {
    ...
    final String url =
        'http://192.168.1.104/database/files/get_office_for_ncar.php?campus=$campus&year=$year&quarter=$quarter';

    try {
      final response = await http.get(Uri.parse(url));

      print("Response from PHP script: ${response.body}");
