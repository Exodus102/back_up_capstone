...
import 'package:css_website_access/pages/reports/report_page_directors_data_table.dart';
import 'package:css_website_access/pages/reports/view_report_page.dart';
import 'package:css_website_access/pages/reports/view_report_page_director.dart';
...
class ReportsPageDirectors extends StatefulWidget {
  final String? fname;
  final String? lname;
  final Uint8List? profileImage;
  final String? redirectPage;
  final String? campus;
  const ReportsPageDirectors({
    super.key,
    this.fname,
    this.lname,
    this.profileImage,
  ...
  @override
  State<ReportsPageDirectors> createState() => _ReportsPageDirectors();
}

class _ReportsPageDirectors extends State<ReportsPageDirectors> {
  String? selectedDate;
  List<String> date = [];
  bool isLoading = true;
